...
public static class NucleiScanOptions {
...
public static class NucleiScanSession {
...
public static class AttackSurfaceAssessment {
...
public static class ComprehensiveNucleiResult {
    private final String target;
    private final String sessionId;
